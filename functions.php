...
function custom_post_type() {
    ...
    register_post_type( 'staff', array(
        ...
        'label'               => __( 'front-page', 'front-page' ),
        'description'         => __( 'Front Page', 'front-page' ),
        'labels'              => array(
	        'name'                => _x( 'Front Page', 'Post Type General Name', 'front-page' ),
	        'singular_name'       => _x( 'Gallery', 'Post Type Singular Name', 'front-page' ),
	        'menu_name'           => __( 'Front Page', 'front-page' ),
	        'parent_item_colon'   => __( 'Parent Page', 'front-page' ),
	        'all_items'           => __( 'All Pages', 'front-page' ),
	        'view_item'           => __( 'View Page', 'front-page' ),
	        'add_new_item'        => __( 'Add New Page', 'front-page' ),
	        'add_new'             => __( 'Add New', 'front-page' ),
	        'edit_item'           => __( 'Edit Page', 'front-page' ),
	        'update_item'         => __( 'Update Page', 'front-page' ),
	        'search_items'        => __( 'Search Page', 'front-page' ),
	        'not_found'           => __( 'Not Found', 'front-page' ),
	        'not_found_in_trash'  => __( 'Not found in Trash', 'front-page' ),
	    ),
        'supports'            => array( 'title' ),
        'taxonomies'          => array( 'genres' ),
        'hierarchical'        => false,
